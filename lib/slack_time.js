...
function helpMessage() {
  return "Hi! Type /time followed by a message containing a time and it will be shown in the timezone of everybody in the channel. Try these: 3pm, in 45 minutes, tomorrow from 1pm to 2pm. If somebody's time zone is missing, you can let them know they can set their time zone at https://my.slack.com/account/settings";
}
